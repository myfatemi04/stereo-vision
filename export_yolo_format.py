...
def do_export(bag_id, camera_name, output_dir):
    ...
    for image_id, (boxes, confidences, labels) in tqdm.tqdm(
        enumerate(foundation_model_annotations),
        desc="Saving images and annotations",
        total=len(foundation_model_annotations),
    ):
        _, frame = cap.read()
        h, w, _ = frame.shape
        ...
        fold_path = os.path.join(
            output_dir, "cameras", camera_name, "folds", fold_subdir
        )
